odoo.define("pos_sale_backport.models", function (require) {
    "use strict";
    ...
    models.load_models([
        {
            ...
            domain: function (self) {
                return [["id", "=", self.config.down_payment_product_id[0]]];
            },
    ...
    models.Order = models.Order.extend({
        ...
        _reduce_total_discount_callback: function (sum, orderLine) {
            ...
            return super_order_model._reduce_total_discount_callback.apply(
                this,
                arguments
            );
        },
    ...
    models.Orderline = models.Orderline.extend({
        initialize: function (attributes, options) {
            ...
            this.sale_order_line_id =
                this.sale_order_line_id || options.sale_order_line_id;
            this.down_payment_details =
                this.down_payment_details || options.down_payment_details;
        ...
        export_as_JSON: function () {
            const json = super_order_line_model.export_as_JSON.apply(
                this,
                arguments
            );
            ...
            json.down_payment_details =
                this.down_payment_details &&
                JSON.stringify(this.down_payment_details);
            return json;
        },
        ...
        export_for_printing: function () {
            var json = super_order_line_model.export_for_printing.apply(
                this,
                arguments
            );
